...
import type { ExternalBlob as _ExternalBlob, Meal as _Meal, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createMeal(arg0: ExternalBlob, arg1: string, arg2: string, arg3: bigint): Promise<Meal> {
        if (this.processError) {
            try {
                const result = await this.actor.createMeal(await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg0), arg1, arg2, arg3);
                return from_candid_Meal_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getDailySummary(): Promise<[bigint, bigint]> {
        if (this.processError) {
            try {
...
async function from_candid_Meal_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Meal): Promise<Meal> {
...
async function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        imageFile: await from_candid_ExternalBlob_n13(_uploadFile, _downloadFile, value.imageFile),
...
async function from_candid_vec_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Meal>): Promise<Array<Meal>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Meal_n11(_uploadFile, _downloadFile, x)));
}
